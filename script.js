...
heartImage.onload = () => {
    ...
    document.getElementById('heartButton').addEventListener('touchstart', function(event) {
        event.preventDefault(); // Evita comportamentos padrão do toque, como zoom da página
